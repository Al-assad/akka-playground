-- reference: https://github.com/akka/akka-persistence-jdbc/blob/v5.0.4/core/src/main/resources/schema/h2/h2-create-schema.sql

CREATE TABLE IF NOT EXISTS "event_journal"
(
    "ordering"           BIGINT                NOT NULL AUTO_INCREMENT UNIQUE,
